...
.. |Imp| image:: https://cdn.discordapp.com/emojis/535533809655873556.png?v=1
    :width: 1.375em
    :height: 1.375em
...
.. |Ice_Barrage| image:: https://cdn.discordapp.com/emojis/537340400185245701.png?v=1
    :width: 1.375em
    :height: 1.375em
...
-  |impact|  only stuns when it hits, for 1.2s, 100% ability damage, 15s cd

-  |deep|  only stuns when hits, for 3.6s i think, 200% ability damage, 15s cd

-  |asphyx|  always stuns Telos **regardless** of accuracy, so your best stun 3.6s stun, 20s cd

-  |icebarrage|  do not stun but bind, so break his freedom. especially with 4taa, makes ancients pretty sick if used properly
...
-  |Imp| ,  |Deep| , auto  |Asphyx| 

-  |Asphyx| , cancel after 3rd hit with  |Imp| ,  |Deep| 

https://clips.twitch.tv/CrispyAcceptablePuppyRickroll



-  |Asphyx| , cancel after 3rd hit with  |Deep| , auto/wait  |Imp|  (**DONT** impact right after deep impact, see common mistakes)



-  |Deep| , Auto  |Asphyx| , cancel after 3rd hit  |Imp|  (works i guess just not comfortable for me)



-  |Deep| , Auto  |Imp| ,  |Asphyx|  
...
-  |Asphyx| ,  |Deep| ,  |Imp| , no waiting ( |Deep|   |Imp|  just does some bad damage with no stunning, just use  |Wrack| )



**P4**:

- At fonts, can damage him with  |Imp|  (+ stacked Auto  |Deto| ) which will proc his freedom, and then (auto)  |Deep|   |Imp|   |Asphyx|  
...
- Break freedom with  |Ice_Barrage| / |Imp|  when he is charging, then  |Asphyx|  tick before he is about to attack,  |Wrack|   |Imp|  if you want to be safe afterwards, see below
...
- Ideally though its not usually worth to impact right after sun if you started properly; the way his autos line up, waiting 1 tick to get 50 adren and  |Asphyx|  then cancel with  |Deep|  after 3rd hit creates more stall 
...
I chose  |Asphyx| . Asphyxiate first without breaking freedom is to have consistency, it always stuns so if you splash no worries for stall before tendrils
...
- There are a lot of ways to deal with insta smp, and a few diff ways to stun, the one that's least rng is break his freedom while he is charging anima bomb then  |Asphyx|  as he is attackable. On maniacal it's usually fine to yolo stun as long as you didn't brew down
