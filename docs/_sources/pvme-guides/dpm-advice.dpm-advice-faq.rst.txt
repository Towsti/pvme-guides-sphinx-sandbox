...
.. |Needle_Strike| image:: https://cdn.discordapp.com/emojis/535541259108876293.png?v=1
    :width: 1.375em
    :height: 1.375em
...
.. |Mut_Fury| image:: https://cdn.discordapp.com/emojis/535532879334080527.png?v=1
    :width: 1.375em
    :height: 1.375em
...
**How to fix:** by using ‘filler’ abilities such as Sonic Wave  |Sonic| , Concentrated Blast  |Conc| , Dazing Shot  |Dazing| , Needle Strike  |Needle_Strike| , Fury  |Fury|   |Mut_Fury| , Cleave  |Cleave| , and Decimate  |Deci|  (abilities that have decent damage with a short cooldown) in-between the strong abilities, you can craft a rotation where you will never run into a scenario where you have to resort to low damage abilities.  
