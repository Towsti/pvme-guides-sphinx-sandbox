...
.. |spiritshield| image:: https://cdn.discordapp.com/emojis/643161660231516165.png?v=1
    :width: 1.375em
    :height: 1.375em

.. |holyelixir| image:: https://cdn.discordapp.com/emojis/643161659984183351.png?v=1
    :width: 1.375em
    :height: 1.375em

.. |spectralsigil| image:: https://cdn.discordapp.com/emojis/643161640162033666.png?v=1
    :width: 1.375em
    :height: 1.375em

.. |arcanesigil| image:: https://cdn.discordapp.com/emojis/643161640350646293.png?v=1
    :width: 1.375em
    :height: 1.375em

.. |divinesigil| image:: https://cdn.discordapp.com/emojis/643161640342388767.png?v=1
    :width: 1.375em
    :height: 1.375em

.. |elysiansigil| image:: https://cdn.discordapp.com/emojis/643161640107245580.png?v=1
    :width: 1.375em
    :height: 1.375em

.. |corporealbone| image:: https://cdn.discordapp.com/emojis/643162604361089080.png?v=1
    :width: 1.375em
    :height: 1.375em
...
.. image:: https://i.imgur.com/GIExXXw.png
...
-  |spiritshield|   **Spirit shield** `1/64`

-  |holyelixir|   **Holy elixir** `1/171`

-  |spectralsigil|   **Spectral sigil**

-  |arcanesigil|   **Arcane sigil**

-  |divinesigil|   **Divine sigil**

-  |elysiansigil|   **Elysian sigil**

-  |corporealbone|   **Corporeal bone** `1/2500 (500 threshold)`
...
.. image:: https://i.imgur.com/OBVXVEc.png
...
-  |masterworkspearofannihilation|   **Masterwork Spear**

-  |aosor|  /  |aos|   **Amulet of souls**
...
.. image:: https://i.imgur.com/BRMEDBz.png

**Action Bar**

.. image:: https://i.imgur.com/ZLZzvG4.png

**Cannon Placement**

.. image:: https://thumbs.gfycat.com/PartialSameIvorygull-size_restricted.gif
...
**Non-instanced corp:**
 ...
 |gbarge|  →  |dismember|  →  |gflurry|  (stall for 1st hit)>  |cleave|  →  |zgs|  |spec|  →  |sever|  →  |gfury|  →  |cleave|  →  |deci|  →  |assault|  →  |cleave|  →  |deci|  →  |cane|  → improvise as it is near death.
...
Auto +  |dismember|  →  |cleave|  →  |zerk|  asap +  |enhreplen|  /  |limitless|   based on cd (don't use sever on corp unless you are under 60% adren) →  |gbarge|  →  |cleave|  →  |deci|  →  |assault|  →  |sever|  →  |cleave|  →  |cane|  →  |deci|  → improvise.
...
Looks roughly like:
 ...
 |gbarge|  →  |dismember|  →  |gflurry|  →  |cleave|  →  |sever|  →  |deci|  →  |slaughter|  →  |cleave|  →  |assault|  →  |bloodtendrils|  →  |deci|  →  |cleave|  →  |cane|  → improvise.
