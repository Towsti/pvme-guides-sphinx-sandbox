...
.. image:: https://i.imgur.com/nxKR1Io.png
...
.. image:: https://i.imgur.com/YTosKHl.png
...
-  |adrenurn|   **Adrenaline urn** `Prevents adren loss after dropping combat, stores up to 1000% adrenaline`, can be removed if using Persistent Rage relic

-  |ancientshard|   **Ancient elven ritual shard** `Restores prayer overtime, 5 minute cooldown`

.. image:: https://i.imgur.com/yQIpVUl.png



**Melee Preset**

Melee may be used on sides without Ahrim to deal high burst damage in order to minimize Karil specs. When meleeing you want to start every kill with 100% adrenaline. You will  |zerk|  every single kill and in order to upkeep your adren you need to manage your adrenaline carefully. This is why you have multiple apots and dummies. As melee you will always incite.
...
.. image:: https://i.imgur.com/eBU4tzx.png
...
Range: Auto →  |mechchin|  3t  |snipe|  /  |needle|  (Activate  |undeadslayer|  as snipe/needle hits) →  |corruptshot| / |frag|  →  |dbow|   |eofspec|  → Improvise
...
Range: Auto →  |mechchin|  3t  |snipe|  /  |needle|  (Activate  |undeadslayer|  as snipe/needle hits) →  |dbow|   |eofspec|  → Improvise

Melee:  |zerk|  → (Activate  |undeadslayer| ) Auto +  |cleave|  → ( |limitless|  +  |ingen| )  |cane|  →  |deci|  →  |sever|  →  |cleave|  /  |backhand|  → improvise
...
Melee: (Activate  |undeadslayer| ) Auto +  |cleave|  → ( |ingen| )  |cane|  →  |quake|  →  |deci|  →  |cleave|  →  |sever|  /  |backhand|  → improvise
...
Range (Incite): ( |undeadslayer| ) Auto +  |corruptshot|  +  |surge|  →  |mechchin|  3t  |snipe|  /  |needle|  →  |dbow|   |eofspec|  → Improvise

Range (DPS): ( |undeadslayer| ) Auto +  |mds|  +  |surge|  →  |mechchin|  3t  |snipe|  /  |needle|  →  |dbow|   |eofspec|  → Improvise
...
East: <https://youtu.be/9DQL7TEYQ00?t=209>
...
Ranged (east): Auto +  |corruptshot|  /  |frag|  →  |mechchin|  3t  |snipe|  /  |needle|  (Activate  |undeadslayer|  as snipe/needle hits) →  |dbow|   |eofspec|  → Improvise
...
Ranged (west): Target Karil → Auto + 3t  |snipe|  /  |mds|  (Activate  |undeadslayer|  as snipe/dazing hits) →  |dbow|   |eofspec|  →  |dbow|   |eofspec|  → Switch targets once Karil is dead and improvise
...
- Encourage your partners to save surge spots (see this guide: <https://youtu.be/DpF579ZJP_Q>).
