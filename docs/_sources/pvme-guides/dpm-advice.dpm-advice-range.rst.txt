...
.. |decimation| image:: https://cdn.discordapp.com/emojis/643848618477879328.png?v=1
    :width: 1.375em
    :height: 1.375em

.. |Nex| image:: https://cdn.discordapp.com/emojis/513213159071547395.png?v=1
    :width: 1.375em
    :height: 1.375em
...
.. image:: https://i.imgur.com/jCHwBgT.png



.. image:: https://i.imgur.com/6Fmy2MK.png
...
.. image:: https://i.imgur.com/ZKwiC3l.png
...
.. image:: https://i.imgur.com/lENhef2.png





When building a rotation, ability prioritizations AND cooldowns should be on your mind. Filler abilities such as Needle Strike |needle|  and Dazing Shot |dazing|  should be used in-between high damage abilities such as Snipe |snipe| , Corruption Shot |corruptshot| , Binding Shot-Flanking |bindingshot| , and Fragmentation Shot-Walk |frag| . Any basic ability with damage lower than Needle/Dazing would be considered a weak ability (Piercing |piercing| , tuska |Tuskas| , sacrifice |Sacrifice| , binding shot |bindingshot|  without flanking, richochet |ricochet|  on 1v1).



If you are 2h or DW camping you will be limited to only one filler ability (Dazing Shot or Needle Strike, respectively. Thus, try to utilize Dazing or Needle as often as possible in your rotations. A basic pattern of *Needle |needle|  -> Ability -> Ability -> Repeat* is recommended for camping rotations.
...
.. image:: https://i.imgur.com/nhRFoZ1.png
...
At this stage, it is likely that there's a fundamental lack of understanding regarding how to build a rotation, and when to perform certain abilities. Starting out, it's recommended to use the following Revolution bar. Remember to use Death's Swiftness |DeathsSwift|  when it is off cooldown (Ult once every minute), and use a ring of vigour |vigour|  switch and an adrenaline potion |replen| . It is extremely important to learn how to cancel channels at this stage. Otherwise your DPS will suffer greatly.
...
Rapid Fire  |rapid|  > Snapshot  |snap|  > Shadow Tendrils  |shadowtend|  > Rapid Fire  |rapid|  > Bombardment  |bombard|  > Snapshot  |snap| 
...
Snapshot  |snap|  > Rapid Fire  |rapid|  > Shadow Tendrils  |shadowtend|  > Bombardment  |bombard|  > Snapshot  |snap|  > Rapid Fire  |rapid| 



Without Adrenaline Potion:

Snapshot  |snap|  > Shadow Tendrils  |shadowtend|  > Rapid Fire  |rapid|  > Snapshot  |snap|  > Bombardment  |bombard| 
...
Snapshot  |snap|   > Rapid Fire  |rapid|  > Shadow Tendrils  |shadowtend|  > Tight Bindings  |tight|  > Snapshot  |snap|  > Rapid Fire  |rapid|  
...
Rapid Fire  |rapid|  > Snapshot  |snap|  > Shadow Tendrils  |shadowtend|  > Rapid Fire  |rapid|  > Tight Bindings  |tight|  > Snapshot  |snap| 



Without Adrenaline Potion:

Snapshot  |snap|  > Shadow Tendrils  |shadowtend|  > Rapid Fire  |rapid|  > Snapshot  |snap|  > Tight Bindings  |tight| 



Two notes:

- We remove Bombardment  |bombard|  from our threshold rotations as they are all replaced with Flanking. 



- Remember to use your flanking switch for basics, not just for thresholds. Using flanking on Binding Shot |bindingshot|  improves that ability from 100% ability damage to 220% ability damage and is often overlooked by inexperienced players.
...
*Equip DW PF -> Activate Death's Swiftness  |DeathsSwift|  -> Equip 2h within GCD -> Click target (auto attack will come out here) -> Activate Ability*

- Using Shadow Tendrils  |shadowtend|  with 2H after using a DW ability with a 'fastest' speed weapon allows for stacking an auto on top of the tendrils.
...
.. image:: https://i.imgur.com/qXlCYVf.png
...
For example, the most effective bolt when fighting <#534612663523737619>  |Nex|  are Ruby bolts  |RubyBakri|  as they are the best dps bolts. However, when attacking minions the most effective bolt becomes Hydrix  |HydrixBakri|  as minions have a soft hitcap of 1000 so any Ruby procs are wasted. During the last phase, the most effective bolt on Nex becomes Onyx  |OnyxBakri|  as she is lower than 100k hp thus reducing Ruby's effectiveness. 
...
This technique allows using Snipe in 3 ticks as opposed to its intended 4 tick duration. It will still hit at the same time as it normally would. Needless to say being able to use Snipe as a non-channeled ability (within a GCD) is very strong and is useful everywhere though the major drawback is this method requires ability queing to be enabled. Players may find queing difficult to use so use at your own discretion.  
 ...
 • Method requires Nightmare Gauntlets  |nightmaregauntlets|  to be equipped.



Simply use Snipe, then queue up any other ability prior to GCD. For example: Snipe  |snipe|  -> Queue piercing shot |piercing| . This will cause Piercing shot to come out on the following GCD after Snipe instead of having to wait 4 ticks for the full channel of Snipe. After you fire the queued ability off your character will be rooted in place for 1 tick.
...
Certain weapon types for ranged can cause abilities that normally take 2 ticks to deal damage to only take 1 tick to deal damage depending on your distance from your target. These abilities include  |snap| ,  |rapid| ,  |piercing| ,  |ricochet| , dazing |dazing| . Slow abilities which are unaffected include:  |needle| ,  |bindingshot| , and  |tight| .
