...
.. |zarosess| image:: https://cdn.discordapp.com/emojis/643162860830326824.png?v=1
    :width: 1.375em
    :height: 1.375em

.. |crestzaros| image:: https://cdn.discordapp.com/emojis/643161512177041428.png?v=1
    :width: 1.375em
    :height: 1.375em
...
.. |glimmeringscale| image:: https://cdn.discordapp.com/emojis/643163068846702596.png?v=1
    :width: 1.375em
    :height: 1.375em

.. |imbuedbladeslice| image:: https://cdn.discordapp.com/emojis/643169149639589918.png?v=1
    :width: 1.375em
    :height: 1.375em
...
.. |adrenurn| image:: https://cdn.discordapp.com/emojis/656426717413507074.png?v=1
    :width: 1.375em
    :height: 1.375em
...
.. image:: https://i.imgur.com/7Fq2gcD.png
...
-  |zarosess|   **Zarosian essence**

-  |crestzaros|   **Crest of zaros**

-  |dragonriderlance|   **Dragonrider lance**

-  |glimmeringscale|   **Glimmering scale**

-  |imbuedbladeslice|   **Imbued blade slice**
...
.. image:: https://i.imgur.com/wvJNWxy.png
...
If you are not comfortable with weapon switching then you may use either only a scythe or only drygores. DW Melee is used for bladed dive, and again a shield is used for resonance.  |soulsplit|  +  |aosor|  results in high sustain, and the food is used for any panic healing.

-  |luckpotion|   **Enhanced luck potion** `Gives tier 3 luck, can be removed if swapping to lotd`



.. image:: https://i.imgur.com/p0r46NJ.png
...
In the advanced presets, we sacrifice food for more switches. The magic preset expects the player to be utilizing 4TAA, and dragon rider amulet switching. The defender is used as both a shield and planted feet switch. Sustain will be done exclusively via  |soulsplit|  +  |aosor| . You can upgrade to a scrimshaw and tectonic if you want. This preset is made for roughly 30 minute trips.

-  |luckpotion|   **Enhanced luck potion** `Gives tier 3 luck, can be removed if swapping to lotd`

-  |adrenurn|   **Adrenaline urn** `Prevents adren loss after dropping combat, stores up to 1000% adrenaline`
...
.. image:: https://i.imgur.com/Gfay885.png
...
If opting to melee, a DW/2H switching preset is used. Again, we sustain solely through  |soulsplit|  +  |aosor| , with excalibur to aid in healing. This preset is made for roughly 30 minute trips.
...
.. image:: https://i.imgur.com/2Gchgth.png





Vindicta's Attack Rotation
...
3 Autos → Dragonfire → 3 Autos → Hurricane → Repeat 



**Phase 2 (100k - 0 hp)**

Melee Auto → Ranged Auto → Melee Auto → Fly + Dragonfire → Repeat



The boss may be done on any combat style but melee can get faster killtimes and has access to vampyrism scrimshaw for learners, while mage is good for increased mobility and access to vulnerability. It is possible to soul split  |soulsplit|  the entire encounter with decent dps. Otherwise, it's recommended to prayer flick/resonance the ranged hits. As long as minimum time is spent within the dragonfire lines, survivability should not be a major issue.
...
**Kill 1: (100% adrenaline required)**
 ...
 |zerk|  → TC +  |gbarge|  →  |cleave|  →  |deci|  →  |limitless|  +  |destroy|  →  |gflurry|  →  |cleave|  →  |assault|  →  |deci|  → 5t Auto +  |cleave|  →  |dismember|  →  |freedom|  AA → Improvise (Finish kill on 82%+ adrenaline, if you triple imp proc or asr/relentless 3hit flurry under sigil and dont 5t auto later)



**Kill 2: (82% adrenaline required)**

 |gbarge|  →  |slaughter|  →  |dismember|  →  |destroy|  →  |enhreplen|  +  |zerk|  → Auto +  |cleave|  →  |deci|  →  |sever|  →  |freedom|  AA →  |cleave|  →  |assault|  →  |deci|  → 5t Auto +  |cleave|  **OR** 5t Auto +  |gflurry|  >  |cane|  → Basics till kill ends



**Kill 3: (Improvise)**

 |gbarge|  →  |dismember|  →  |slaughter|  (if high adren) **OR**  |deci|  (if low adren) →  |destroy|  →  |zgs|   |spec|  → Auto +  |cleave|  →  |assault|  → 3 Hit  |gflurry|  →  |cane|  →  |slaughter|  (if still high HP, finish kill on 100% adrenaline)



Rotate these three rotations with 30 minute trips



https://youtu.be/jhKDHW5ePfw
