...
.. |barrowskhopeshmh| image:: https://cdn.discordapp.com/emojis/580176857144492042.png?v=1
    :width: 1.375em
    :height: 1.375em

.. |vorago| image:: https://cdn.discordapp.com/emojis/572867742613635082.png?v=1
    :width: 1.375em
    :height: 1.375em

.. |aod| image:: https://cdn.discordapp.com/emojis/580167371365548042.png?v=1
    :width: 1.375em
    :height: 1.375em

.. |Seiryu| image:: https://cdn.discordapp.com/emojis/583430543321071626.png?v=1
    :width: 1.375em
    :height: 1.375em

.. |BSD| image:: https://cdn.discordapp.com/emojis/583430542326759435.png?v=1
    :width: 1.375em
    :height: 1.375em

.. |Ambassador| image:: https://cdn.discordapp.com/emojis/583430542809235458.png?v=1
    :width: 1.375em
    :height: 1.375em

.. |solak| image:: https://cdn.discordapp.com/emojis/580167371310891029.png?v=1
    :width: 1.375em
    :height: 1.375em
...
.. |dragonriderlance| image:: https://cdn.discordapp.com/emojis/643161541931171872.png?v=1
    :width: 1.375em
    :height: 1.375em
...
.. |replenpot| image:: https://cdn.discordapp.com/emojis/641337470491033600.png?v=1
    :width: 1.375em
    :height: 1.375em
...
.. image:: https://i.imgur.com/aI8RM8r.png
...
.. image:: https://i.imgur.com/SxmrcM5.png



2h revo++ bar

.. image:: https://i.imgur.com/2Bis7lJ.png
...
.. image:: https://i.imgur.com/w0sVzOo.png



2h revolution bar

.. image:: https://i.imgur.com/1zvgPM9.png
...
Camping in this context refers to the exclusive usage of either DW or 2H without taking advantage of the benefits from switching. Most players will start learning melee by grabbing a 2h or DW and camping with said weapon. While you are limited to what rotations you can do while camping 2h or DW, it is still important to optimize with what you have. Your rotation will be generally built around either Lesser Fury  |fury|  or Greater Fury  |gfury| , depending on availability. High damage basics such as Cleave  |cleave|  (2h exclusive), Decimate  |deci|  (DW exclusive), and Sever  |sever|  should be used as often as possible following Fury. 



Rotations will following a simple scheme as follows: Fury  |fury|  -> Ability -> Ability -> Repeat.



The general idea is to build to your Berserk  |Berserk| , and then within Berserk, use Assault  |assault| , then either Destroy  |destroy|  (DW) or Hurricane  |cane|  (2h), and then if you have the adrenaline to spare, use either Flurry  |gflurry|  (DW) or Quake  |quake|  (2h).



2h

Build to 100% -> Berserk  |Berserk|  -> Assault  |assault|  -> Hurricane  |cane|  -> Quake  |quake|  -> Repeat



DW

Build to 100% -> Berserk  |Berserk|  -> Assault  |assault|  -> Destroy  |destroy|  -> Flurry  |gflurry|  -> Repeat
...
Should the opportunity arise at group bosses flanking can be incredibly powerful. Backhand  |backhand|  becomes your 2nd most powerful basic inside of Berserk while Forceful Backhand  |fbackhand|  becomes your 4th best threshold in Berserk. The basic ability Backhand should be used as often as possible and the threshold Forceful Backhand should be used either in Berserk or in-between Berserk cooldowns. 
...
Berserk  |Berserk|  -> Assault  |assault|  -> Hurricane  |cane|  -> Forceful Backhand-Flanking  |fbackhand|  -> Repeat



**DW Camping**

Berserk  |Berserk|  -> Assault  |assault|  -> Destroy  |destroy|  -> Forceful Backhand-Flanking  |fbackhand|  -> Repeat



*Note that for DW, once you have Greater Flurry  |gflurry|  unlocked it should be used as your 3rd threshold inside Berserk. Flanking would be downgraded to a threshold used in-between Berserk cooldowns.



This perk should be placed on a Dual Wield Off-hand switch and upgraded to your highest tier available (Drygore |drygorelongmh|  t90 or dyed-Khopesh |barrowskhopeshmh|  t92). 



Example bosses to bring flanking to include: Vorago  |vorago| , Angel of Death  |aod| , group ED1-3 |Seiryu|  |BSD|  |Ambassador| , Solak |solak| , and any other group bossing.
...
The only basic bleed in melee affected by Lunging is Dismember  |dismember| . Since Dismember cannot be walked to gain bonus damage, the effects of Lunging will always activate for Dismember, thus it is **strictly** an upgrade over non-lunging Dismember. In fact, the effect of Lunging is extra strong on Dismember *because* Dismember cannot be walked (the same applies to the 99 Strength Cape effect). With Lunging 4 and Strength Cape effect combined, Dismember  |dismember|  becomes the **strongest basic ability** for melee outside of Berserk.
...
A Dual Wield Off-hand switch should be used for this perk and later upgraded to a Masterwork Spear of Annihilation  |masterworkspearofannihilation|  due to it further extending the duration of Dismember.
...
The biggest jump in DPM will come from incorporating weapon juggling of DW and 2h weapons. Having both weapon styles gives access to both DW Decimate |deci|  and 2h Cleave |cleave|  basic abilities, each sporting a strong 188% ability damage and a low 7s cooldown. **Even if you have to pair a high tier weapon with a lower tier weapon, the ability to access both Deci/Cleave is worth it** (eg. Drygores with Dragon Rider Lance). With DW/2h Switching, it is possible to break beyond the 170k DPM barrier that Camping generally struggles to overcome.
...
Example pairings of DW and 2h weapons:
 ...
 • t80 Dragon Rider Lance |dragonriderlance| 

 • t90 Noxious Scythe |noxscythe|  

 • t92 Zaros Godsword |zgs| 





Here we will abandon camping rotations built around Fury  |fury|   |gfury|  

Fury  |fury|   |gfury|  -> Basic -> Basic -> Repeat.



Your new DW/2h rotations will be built around Decimate |deci|  and Cleave |cleave| 

Deci  |deci|  -> Cleave  |cleave|  -> Ability -> Ability -> Repeat.

OR 

Cleave  |cleave|  -> Deci  |deci|  -> Ability -> Ability -> Repeat.



Substitute 'Ability' with other strong basic abilities such as Dismember |dismember| , Sever |sever| , Fury |gfury| , Backhand-Flanking |fbackhand| , etc. We use Deci/Cleave as often as possible as they each have a 7s cooldown and deal great damage at 188% ability damage. 
...
Berserk |Berserk|  -> Assault |assault|  -> Destroy |destroy|  -> Forceful Backhand |fbackhand|  
...
Berserk |Berserk|  -> Assault  |assault|  -> Destroy  |destroy|  -> Greater Flurry |gflurry| 



Without Adrenaline Pot

Berserk |Berserk|  -> Assault  |assault|  -> Hurricane |cane|  -> Forceful Backhand |fbackhand| 
...
Berserk |Berserk|  -> Assault  |assault|  -> Hurricane  |cane|  -> Greater Flurry |gflurry|  



Note: use Greater Flurry |gflurry|  over Forceful Backhand-Flanking |fbackhand|  if you have it available
...
.. image:: https://i.imgur.com/mwMXofd.png
...
.. image:: https://i.imgur.com/sQpb7RM.mp4
...
Thus, you can perform an auto attack on every Berserk |Berserk|  activation by doing the following:
...
If you will be primarily doing Vorago or Solak, it is recommended to pick up a Greater Barge codex  |gbarge| . Its special affect allows you to turn channeled abilities into bleeds.
...
Berserk  |Berserk|  + Adrenaline Potion  |replenpot|  / Limitless Sigil  |limitless|  → Berserk Cooldown → ZGS Special → ZGS Cooldown → Repeat
...
One of the more powerful aspects of melee in group pvm is access to the SWH special attack without the need for an Ingenuity of the Humans ability |ingen| . If you intend to do group PvM it is recommended to buy a SWH and use its special attack at high defence bosses (eg. Vorago, Yakamaru, Beast Master, Angel of Death). Usage of the SWH varies from boss to boss and will be covered more specifically in our boss guides.
...
Greater Barge  |gbarge|  can be unlocked through consuming a Greater Barge Ability Codex and transforms your lesser Barge ability to Greater Barge. The description of Greater Barge is as follows:
...
Wait 5 ticks to proc Greater Barge -> Barge Target -> Activate channeled threshold (eg. Assault |assault| , Destroy |destroy| , or Greater Flurry |gflurry| ) -> Continue DPS rotation within next GCD.
...
Anticipate  |anti|  -> Berserk  |Berserk|  -> gBarge  |gbarge|  -> Greater Flurry  |gflurry|  (bleed) -> Continue with DPS

Using greater flurry as gBarge's bleed will allow its full duration to take effect thereby lowering Berserk's cooldown. In this rotation, Anticipate can be replaced with Resonance  |res|  if you think you will have a hard time surviving after you Berserk. 
...
The 'bleed' from gBarge is not a true bleed. There are several ramifications of this:
  ...
  2) Equipping a different tier weapon *after* you apply the bleed will change the bleed's damage according to the latter weapon tier. For example, if you apply the gBarge bleed with Drygores (t90) equipped, then switch to ZGS (t92) the damage will be calculated as a t92 weapon.
    ...
    2.1) If the initial weapon has a special effect against a target, the effect can activate *after* you switch to another weapon. For example, apply a gBarge bleed with Terrasaur Maul |terramaul|  then switching to Khopeshes will apply its special buff against Ranged monsters during its bleed calculations, to give T92 + 12.5% damage, rather than T80 + 12.5%.
...
.. image:: https://i.imgur.com/gjDPnY1.png



**5 Minute 0% Start No Mutated/Sigil/ZGS(Courtesy of <@!236559830121185290>)**

.. image:: https://i.imgur.com/fuHQDk3.png
