...
.. |barrowselitetectlegs| image:: https://cdn.discordapp.com/emojis/580177522700976138.png?v=1
    :width: 1.375em
    :height: 1.375em
...
.. |darkform| image:: https://cdn.discordapp.com/emojis/659122103269982228.png?v=1
    :width: 1.375em
    :height: 1.375em
...
.. |barrowstectlegs| image:: https://cdn.discordapp.com/emojis/580177561175457812.png?v=1
    :width: 1.375em
    :height: 1.375em
...
.. image:: https://i.imgur.com/fAXA31v.png
...
.. image:: https://i.imgur.com/BfFBALx.png
...
-  |runepouch|   |Airrune|   |Soulrune|   |Chaosrune| 
 ...
 |Naturerune|  for entangle.



.. image:: https://i.imgur.com/2mIWf4H.png
...
-  |barrowselitetectlegs|   **Elite Tectonic robe bottom (barrows)** `Invigorating 4`

-  |augseissing|   **Seismic singularity** `Flanking 4`

-  |darkform|   **Dark Form** Camp dark form the entire kill
...
.. image:: https://i.imgur.com/MRY4UR9.png
...
- If melee ent, replace  |masterworkspearofannihilation|  with  |vulnbomb| 
...
.. image:: https://i.imgur.com/lRPMb5s.png
...
.. image:: https://i.imgur.com/unHf5Wm.png
...
It is recommended to use a  |ripperpouch| . However a mammoth can be used in conjunction with its scrolls to allow eating solids without losing adrenaline. Jellies and Guthix Rests are used to be able to combo eat big eats as well as for when burst healing is not needed. Spiritual prayers are used so that your scrolls have uptime when needed.



-  |barrowstectlegs|   **Tectonic robe bottom (barrows) ** `Invigorating 4`
...
.. image:: https://i.imgur.com/MvsnJMR.png



If using mammoth

.. image:: https://i.imgur.com/0i6T2MP.png
...
Generally the instance host brings a  |dummy| . Simply replace a  |blueblubber|  with  |dummy| 



.. image:: https://i.imgur.com/Ymi2gpw.png
...
Umbra Mage ent
 ...
 |nat|  →  |Sunshine|  → Build to 100% →  |deto|  →  |vulnbomb|  →  |bloodbarrage|   |deto|   |eofspec|   |gstaff|  →  |dbreath|  →  |bloodbarrage|   |wm|  →  |impact|  →  |bloodbarrage|   |asphyx|  →  |dbreath|  →  |bloodbarrage|   |deep|  →  |eofspec|   |gstaff|  
...
Sigil Deto Start >29s
 ...
 |Sunshine|  →  |freedom|  →  |adrenrenewal|   |limitless|   |deto|  →  |wm|  →  |dbreath|  →  |bloodbarrage|   |conc|  →  |impact|  →  |bloodbarrage|   |sonic|  →  |deep|  →  |bloodbarrage|   |conc|  →  |dbreath|  →  |bloodbarrage|   |asphyx|  →  |wm|  →  |bloodbarrage|   |impact|  →  |dbreath|  →   |freedom|   |icebarrage| 
...
Detonate Rotation (Requires losing target with dummy or reaver)
 ...
 |deto|  (nex) (100%) →  |vulnbomb|  amalg →  |bloodbarrage|   |deto|   |wm|  →  |inquisitorstaff|   |asphyx|  (2-3 hit) →  |dbreath|  → Target amalg  |corruptblast|  →  |bloodbarrage|   |conc|  →  |impact|  → After amalg dies  |StormShards|  and  |vulnbomb|  minion.
...
*Note: Requires invigorating 4 and  |detoboots| *

 |Sunshine|   |adrenrenewal|  →  |bloodbarrage|   |conc|  →  |dbreath|  →  |bloodbarrage|   |wm|  →  |eofspec|   |gstaff|  →  |bloodbarrage|   |impact|  →  |anti|  →  |bloodbarrage|   |dbreath|  →  |deto|  →  |bloodbarrage|   |deto|   |conc|  →  |eofspec|   |gstaff|  →  |bloodbarrage|   |asphyx|  →  |impact|  →  |bloodbarrage|   |wm|  →  |dbreath|  → Improvise
...
**Zaros**
 ...
 |bloodbarrage|   |conc|  →  |impact|  →  |bloodbarrage|   |sgb|   |spec|  →  |dbreath|  → Target Nex  |bloodbarrage|   |sonic|  →  |deto|  →  |bloodbarrage|   |deto|   |wm|  →  |corruptblast|  →  |bloodbarrage|   |asphyx|  →  |dbreath|  →  |bloodbarrage|   |eofspec|   |gstaff|  →  |impact| 
...
*Note:  |adrenrenewal|  Adrenaline renewal potion*

3.6s Zerk P1

 |zerk|   |adrenrenewal|  wait 2t →  |gbarge|  →  |backhand|  →  |gflurry|  →  |freedom|  →  |cane|  →  |cleave|  →  |deci|  →  |zgs|   |assault|  →  |backhand| 

1.8s Zerk P1

 |zerk|   |adrenrenewal|  →  |prep|  →  |gbarge|  →  |gflurry|  →  |freedom|  →  |cane|  →  |gfury|  →  |backhand|  →  |zgs|   |assault|  →  |cleave|  →  |StormShards| 
...
**Melee ent:** *As soon as p1 ends build to 92%+, then use  |zgs|   |spec| , the example rotation assumes you end p1 with <84% adren*

 |anti|  →  |zgs|   |spec|   →  |gbarge|   →  |cleave|  (stall) →  |gflurry|  →  |deci|  → Go to deto spot  |cane|  with  |noxscythe|  → ( |backhand| ) → Target amalg  |sever|  →  |deci|  →  |freedom|  →  |cleave|  → Target Nex+random abil →  |gfury| + |bd| 

Use  |backhand|  instead of  |deci|  on Nex, if 1.8s  |zerk| 





**Quaker:**   |zgs|   |spec|  between U and F →  |gbarge|  →  |cleave|  (stall) →  |gflurry|  →  |deci|  →  |noxscythe|   |cane|  Umbra spot →  |backhand|  → Target Fumus with 188s





**Free Melee:**  |zgs|   |spec|  one south of middle lane →  |gbarge|  →  |cleave|  (stall) →  |gflurry|  →  |deci|  →  |noxscythe|   |cane|  Umbra spot →  |backhand|  → Target Glacies with 188s

Use  |backhand|  instead of  |deci|  if 1.8s  |zerk| 
...
**Melee Ent**
 ...
 |zerk|  →  |gbarge|  →  |backhand|  → minion  |cleave|  →  |limitless|  dw  |assault|  →  |anti|  2h aa → Walk under nex+ |cane|  → 7tick  |gflurry|  →  |deci|  → 5tick aa  |backhand|  → Improvise





**Quaker** After helping Fumus →  |quake|  (stalled) → Release  |quake| + |gfury| . If everyone is on a berserker variant aura and EoF you can skip this and do the same as Free Melee for P3. Or if you have a mage skip this.

 |zerk|  →  |gbarge|  →  |backhand|  →  |cleave|  →  |limitless|   |assault|  →  |deci|  → Walk under Nex+ |cane|  → 7tick  |gflurry|  →  |deci|  → 5tick auto  |backhand|  → Improvise
...
**Zaros**
 ...
 |zerk|  before going to last pillar + 2h Auto pillar →  |backhand|  →  |cleave|  →  |deci|  →  |sever|  → Target Nex  |assault|  →  |cleave|  →  |gfury|  → 5t auto+ |cane|  → improv
...
Use  |RubyBakri| 
 ...
 |ingen|   |swh|  →  |bindingshot|  → auto +  |shadowtend|  →  |rapid|  →  |needle|  →  |snap|  →  |sgb|  |spec|  →  |needle| 
...
(Prephase)  |ecb|  |spec|  →  |snipe|  →  |rapid|  →  |mds| / |snap|  → Target Amalgs → Equip  |HydrixBakri|  →  |corruptshot|  Umbra → Target Glacies  > |Tuskas|  →  |needle| 
...
Use  |HydrixBakri| 
 ...
 |DeathsSwift|  +  |adrenrenewal|  + Auto →  |needle|  →  |sgb|  |spec|  → Equip  |mechchin|   |bindingshot|  →  |needle|  →  |snipe|  →  |snap|  → Equip   |bbc|  |corruptshot|  → Equip  |ecb|  auto+ |shadowtend|  2ticks after casting tendrils equip  |mechchin|  →  |needle|  →  |rapid|  → Equip   |bbc|   |needle|  →  |tight|  →  |bindingshot|   |needle|  →  |snipe|  →  |snap|  →  |needle| 
...
Auto+ |mds|  →  |sgb|  |spec|  →  |rapid|  →  |needle| 

Glacies:

Use  |HydrixBakri| 

 |snipe|  →  |corruptshot|  →  |snap|  →  |freedom|  →  |mds|  →  |needle| 

Cruor: 

Use  |RubyBakri| 

 |shadowtend| +auto(make sure to auto after casting tendrils) →  |snipe|  →  |rapid|  (3-6 tick) →  |mds|  →  |needle| 

Fumus:

Use  |RubyBakri| 

 |surge| + |bd| (early) and tc+ |DeathsSwift|  → Auto+ |bindingshot|  →  |mds|  →  |sgb|  |spec|  →  |needle|  



**Zaros**

Target Nex (can be a bit early, like under 15k hp on pillar). Use  |HydrixBakri|  →  |snipe|  →  |corruptshot|  →  |ecb| +4tickAuto →  |mds|  →  |limitless| + |snap|  →  |snipe|  →  |rapid|  →  |mds|  →  |bindingshot| 
...
**P1**
 ...
 |nat|  →  |Sunshine|  → Build to 100% →  |deto|  →  |bloodbarrage|   |deto|   |eofspec|   |gstaff|  →  |dbreath|  →  |bloodbarrage|   |conc|  →  |wm|  →  |bloodbarrage|   |asphyx|  →  |deep|  →  |bloodbarrage|   |impact|  →  |inquisitorstaff|   |dbreath|  →  |StormShards|  →  |freedom|  →  |comb| 
...
Pre  |deto|  and  |vulnbomb|  Nex

 |bloodbarrage|   |deto|   |wm|  Nex →  |asphyx|  2-3hit →  Target Glacies amalg+cancel asp with  |dbreath|  → Cruor amalg  |corruptblast|  →  |bloodbarrage|   |conc|  →  |chain|  → Target Nex  |comb| 
...
*Note: Requires Invigorating 4 and  |detoboots| *
 ...
 |Sunshine|   |adrenrenewalflask|  →  |bloodbarrage|   |conc|  →  |dbreath|  →  |bloodbarrage|   |sonic|  →  |wm|  →  |bloodbarrage|   |conc|  →  |eofspec|   |gstaff|  →  |bloodbarrage|   |dbreath|  →  |deto|  →  |bloodbarrage|   |deto|   |conc|  →  |eofspec|   |gstaff|  →  |bloodbarrage|   |asphyx|  →   |dbreath|  →  |bloodbarrage|   |wm|  →  |eofspec|   |gstaff|  → improve+lure for pillars
...
Before 4th pillar ( |swh| ) →  |nat|  →  |Vuln|  → ( |Sunshine| ) Skip sun if cannot be done before 3rd pillar is started.

Target pillar  |bloodbarrage|   |wm|  →  |impact|  →  |deep|  →  |deep|  →  |dbreath|  → Target Nex  |bloodbarrage|   |corruptblast|  →  |deto|  →  |bloodbarrage|   |deto|   |conc|  →  |Shatter|  →  |bloodbarrage|   |asphyx|  →  |dbreath|  →  |bloodbarrage|   |eofspec|   |gstaff| 
...
**P1**
 ...
 |ingen|   |swh|  →  |bindingshot| + |voke|  → Auto+ |shadowtend|  →  |rapid|  →  |needle|  →  |snap|  →  |sgb|  |spec|  →  |needle| 



**P2**

(Prephase)  |ecb|  |spec|  →  |snipe|  →  |rapid|  →  |mds|  → Target Amalgs →  |corruptshot|  Cruor amalg →  |Tuskas|  →  |needle| 
...
Equip  |mechchin|   |DeathsSwift|  +  |adrenrenewal|  + Auto → Prephase →  |needle|  →  |snipe|  →  |snap|  →  |needle|  →  |rapid|  →  |needle|  → equip  |bbc|   |bombard|  →  |corruptshot|  →  |needle|  → Auto+ |shadowtend|  →  |mds|  →  |needle|  →  |snipe|  →  |snap|  →  |sgb|   |spec|  →  |mds|  →  |surge| + |StormShards|  
...
Before 4th pillar ( |swh| ) →  |vulnbomb|  →  |DeathsSwift|  →  |needle| 

Target pillar  |shadowtend|  + auto →  |snipe| / |bindingshot|  →  |sgb|  |spec|  →  |needle|  → Target Nex (can be a bit early, like under 15k hp on pillar) →  |ecb|  |spec| +Auto →  |corruptshot|  →  |rapid|  →  |snipe|  →  |limitless|   |snap|  →  →  |Shatter|  → improvise.



Note: if team is really fast and you only build to 50% do:  |limitless| + |snap|  →  |snipe|  →  |rapid|   →  |Shatter| 
...
.. image:: https://i.imgur.com/iCLMQBy.png
...
.. image:: https://i.imgur.com/pb2i0Lz.jpg



Sun spot:

.. image:: https://i.imgur.com/HL0Y4aI.jpg
