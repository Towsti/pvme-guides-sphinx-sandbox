...
.. |royalstabiliser| image:: https://cdn.discordapp.com/emojis/643168122815381534.png?v=1
    :width: 1.375em
    :height: 1.375em

.. |qbdscale| image:: https://cdn.discordapp.com/emojis/643163068892708884.png?v=1
    :width: 1.375em
    :height: 1.375em
...
**Queen Black Dragon (Courtesy of <@!396152093833953282>)**

.. image:: https://i.imgur.com/r43CwWP.png
...
It is _highly_ recommended to have 80 in your preferred combat stat (generally  |range|  or  |Magic|  ), 85 Herblore for Super-Antifires, as well as the Song of the Depths quest completed to reduce the amount of damage received.
...
-  |royalstabiliser|   **Royal crossbow piece** `1/6`

-  |qbdscale|   **QBD Scale** `1/2500 (500 threshold)`
...
.. image:: https://i.imgur.com/9z5HXa6.jpg



**Advanced Preset:**

 |soulsplit|  +  |aosor| , along with occasional excalibur to maintain HP. The melee weapons are used to  |bd|  to activate pillars and the godbook is only used for its passive stats. Make sure to use the dragon slayer perk on your armour and the ability every other kill. It is recommended to use a  |Titan|  /  |ripperpouch| 



 |ds|  at the start of every kill and try to finish every kill at 100% adren. Use dark bow autos at the start of every phase and  |sgb|   |spec|  on the third phase.
...
.. image:: https://i.imgur.com/DMq4jmu.png
...
`The Queen Black Dragon takes on the consistency of crystal; she is more resistant to magic, but weaker to physical damage.` means she will take 25% less  |Magic|  damage and 25% more  |melee|  and  |range|  damage. 

`The Queen Black Dragon hardens her carapace; she is more resistant to physical damage, but more vulnerable to magic.` means she will take 25% less damage from  |melee|  and  |range|  but 25% more  |Magic|  damage.
